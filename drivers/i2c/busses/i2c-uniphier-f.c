				  ...
				  u32 bus_speed, unsigned long clk_rate)
{
	...
	uniphier_fi2c_reg_write(priv, tmp, UNIPHIER_FI2C_CYC);
	uniphier_fi2c_reg_write(priv, tmp / 2, UNIPHIER_FI2C_LCTL);
	uniphier_fi2c_reg_write(priv, tmp / 2, UNIPHIER_FI2C_SSUT);
	uniphier_fi2c_reg_write(priv, tmp / 16, UNIPHIER_FI2C_DSUT);
