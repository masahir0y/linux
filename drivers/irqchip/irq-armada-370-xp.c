...
static const struct irq_chip armada_370_xp_msi_irq_chip = {
	.name = "MPIC MSI",
...
static const struct irq_chip armada_370_xp_msi_bottom_irq_chip = {
	.name			= "MPIC MSI",
...
static const struct irq_chip armada_370_xp_irq_chip = {
	.name		= "MPIC",
