...
extern u32 uniphier_smp_trampoline_poll_addr;
...
static int __init uniphier_smp_prepare_trampoline(unsigned int max_cpus)
{
	...
	writel(virt_to_phys(uniphier_smp_trampoline), uniphier_smp_rom_boot_rsv2);

	uniphier_smp_trampoline_poll_addr = (u32)rom_rsv2_phys;
